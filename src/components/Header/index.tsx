  ...
  return (
    <Flex justifyContent="space-between" alignItems="center" maxWidth="1244px" height="48px" margin="0 auto" marginBottom="5px">
      <Box display="flex" alignItems="center" padding="28px">
        ...
        <img src="/assets/images/rsv_logo.png" alt="logo" width="48px" height="33px" />
      </Box>
      <Box display="flex" alignItems="center" padding="28px">
        ...
        {/* ログイン状態に応じて表示を切り替え */}
        {isLoggedIn ? (
          <Link href="http://localhost:3000/mypage" style={{ padding: '12px', textDecoration: "none", color: "black" }}>マイページ</Link>
        ) : (
